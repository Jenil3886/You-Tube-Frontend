...
import { makeStyles, ThemeProvider } from "@material-ui/styles"; // Updated import
...
const Videos = ({ selectedChipIndex, landingPageVideos, setLandingPageVideos, popularVideosNextPageToken, setPopularVideosNextPageToken }) => {
	...
	let shouldGetMoreResults = (popularVideosTotalResults - landingPageVideos.length) / VIDEOS_PER_QUERY >= 1;
