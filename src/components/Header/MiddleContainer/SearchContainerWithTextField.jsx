...
import { IconTooltip, StyledIconButton, handleSearchFormSubmit, useClearSearchTerm } from "../../../utils/utils";
...
export const SearchContainerWithTextField = () => {
	...
	return (
		<StyledForm onSubmit={(event) => handleSubmit(event)}>
			<SearchBox placeholder="Search" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
