...
const MobileViewSearchDrawer = ({ isSearchDrawerOpen, setIsSearchDrawerOpen }) => {
	...
	return (
		...
		>
			<DrawerToolbar disableGutters>
				...
				>
					<MobileSearchField fullWidth placeholder="Search YouTube" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
